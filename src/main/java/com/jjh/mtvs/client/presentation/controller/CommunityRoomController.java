package com.jjh.mtvs.client.presentation.controller;
...
public class CommunityRoomController {
    ...
    @GetMapping("/recent")
    public ResponseEntity<Page<CommunityResponseDto>> getRecent(@PageableDefault Pageable pageable) {
        return ResponseEntity.ok(communityRoomService.getRecent(pageable));
    }
